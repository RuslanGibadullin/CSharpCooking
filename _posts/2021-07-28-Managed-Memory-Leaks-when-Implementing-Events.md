...
void Main()
{
  InitWR(new StringBuilder("week"));
  ShowTarget(); // Выводит weak
  GC.Collect();
  ShowTarget(); // Выводит weak
}
void InitWR(StringBuilder sb)
{
